...
const hospitals = {
    ...
    'Shaukat Khanum Memorial Hospital': {
        ...
        departments: ['Cardiology', 'Gastroenterology', 'ENT', 'Pulmonology', 'Orthopedic']
    },
    ...
    'Holy Family Hospital': {
        ...
        phone: '(051) 555-6666',
        departments: ['Cardiology', 'Orthopedic', 'Gastroenterology', 'Pulmonology']
    },
    'Pakistan Institute of Medical Sciences': {
        ...
        phone: '(051) 777-8888',
        departments: ['Neurology', 'Pediatrics', 'Gynecology', 'ENT', 'Dermatology']
    }
};
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const dropdown = document.getElementById('hospitalsDropdown');
    if (dropdown) {
        dropdown.innerHTML = '';
        for (const hospitalName in hospitals) {
            const link = document.createElement('a');
            link.href = '#';
            link.textContent = hospitalName;
